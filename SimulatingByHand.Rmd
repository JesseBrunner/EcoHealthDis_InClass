...
\phi = 
$$
We will use these parameters as well as the following starting values for this exercise. We will assume a population of $S=100$ susceptible individuals at time $t=0$ and no recovered and thus resistant individuals ($R=0$). Further, let's assume that a single infected individual rides into town ($I=0$). 
...
we want to figure out what we have at time 1, then time 2, and time 3. 
