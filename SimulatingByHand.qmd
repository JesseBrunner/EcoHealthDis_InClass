...
$$
\begin{aligned}
\beta &=  \hspace{2cm} (\leq 1) \\
\\
\gamma &= \hspace{2cm} (\leq 1) \\
\\
\phi &= \hspace{2cm} (0 \leq \phi \leq 1)
\end{aligned}
$$
...
So, beginning with our starting values ($S=100$, $I=1$, and $R=0$) let us figure out how many $S$, $I$, and $R$ we have at time 1, then time 2, and time 3 and 4. 

| Time | S   | I | R | N   | I/N   | gain in I | loss of I | newly recovered |
|------|-----|---|---|-----|-------|-----------|-----------|-----------------|
| 1    | 100 | 1 | 0 | 101 | 1/101 |           |           |                 |
|      |     |   |   |     |       |           |           |                 |
| 2    |     |   |   |     |       |           |           |                 |
