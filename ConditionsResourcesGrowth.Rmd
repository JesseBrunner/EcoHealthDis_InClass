...
3.  Finally, draw a graph showing three otherwise identical populations, growing logistically over time at either a low, moderate, or high temperature. (Three lines, each one corresponding to a population in a different temperature environment.)
