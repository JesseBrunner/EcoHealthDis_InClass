...
$$
\frac{dN}{dt} = r \left( 1 - \frac{N}{k} \right)
$$

Now consider:

*  What happens to population growth ($dN/dt$) when conditions are good vs. poor? 
*  What happens to population growth ($dN/dt$) when resources are abundance or limiting?
*  Do these change $r$ or $k$ or both? Why?

Our goal today is to sort out some of this in our heads.
...
3.  Now draw a graph showing three otherwise identical populations, growing logistically over time at either a low, moderate, or high temperature. (Three lines, each one corresponding to a population in a different temperature environment.)


# Resource supplementation

1.  Resources, like macronutrients, are also quite fundamental, so let's now draw a curve showing the growth of a species of plant or animal across a range of a limiting nutrient. (Could be plants raised with different levels of nitrogen fertilizer or _Daphnia_ grown with more or less N & P-rich algae as food or something else.)
...
3. Finally, draw a graph showing three otherwise identical populations, growing logistically over time at either a low, moderate, or high levels of this macronutrient. 
